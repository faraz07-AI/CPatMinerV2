...
if __name__ == "__main__":
    ...
    with open("/Users/farazgurramkonda/IdeaProjects/CPatMinerV2/VR_Project_List.txt", "r") as file:
        repo_links = [line.strip() for line in file if line.strip()]

    base_directory = "/Users/farazgurramkonda/IdeaProjects/CPatMinerV2/AtomicASTChangeMining/Res/"
