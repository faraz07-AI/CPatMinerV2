...
public class MainRepoAnalyzer {
	...
	public static String inputPath = "/Users/farazgurramkonda/IdeaProjects/CPatMinerV2/CPatMinerV2/AtomicASTChangeMining/Res";
	private static PrintStream ps;
	
	public static void main(String[] args) throws FileNotFoundException {
		System.setErr(new PrintStream(new FileOutputStream("/Users/farazgurramkonda/IdeaProjects/CPatMinerV2/CPatMinerV2/AtomicASTChangeMining/Res/err.txt"), true));
		ps = new PrintStream(new FileOutputStream("/Users/farazgurramkonda/IdeaProjects/CPatMinerV2/CPatMinerV2/AtomicASTChangeMining/Res/rep.csv"), true);
		...
		String content = FileIO.readStringFromFile("/Users/farazgurramkonda/IdeaProjects/CPatMinerV2/CPatMinerV2/AtomicASTChangeMining/Res/rep.csv");
		...
		FileIO.writeStringToFile(sbRepos.toString(), "/Users/farazgurramkonda/IdeaProjects/CPatMinerV2/CPatMinerV2/AtomicASTChangeMining/selected-repos.csv");
		FileIO.writeStringToFile(sbAuthors.toString(), "/Users/farazgurramkonda/IdeaProjects/CPatMinerV2/CPatMinerV2/AtomicASTChangeMining/selected-authors.csv");
	}
	...
	private static void analyze(final File dir, final String parent) {
        ...
        System.out.println("git name:"+git);
		if (git.exists()) {
			pool.execute(new Runnable() {
				...
				public void run() {
					...
					System.out.println("gitconne:"+gitConn);
					gitConn.connect();
