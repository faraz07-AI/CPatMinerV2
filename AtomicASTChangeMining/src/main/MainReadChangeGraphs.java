...
public class MainReadChangeGraphs {
	...
	public static void main(String[] args) {
		File dir = new File("/Users/farazgurramkonda/IdeaProjects/CPatMinerV2/CPatMinerV2/AtomicASTChangeMining/outputs/");
		read(dir);
		FileIO.writeStringToFile(sbNodes.toString(), "/Users/farazgurramkonda/IdeaProjects/CPatMinerV2/CPatMinerV2/AtomicASTChangeMining/nodes.csv");
		ArrayList<Integer> l = new ArrayList<>(nodeBin.keySet());
		Collections.sort(l);
		for (int i : l) {
			sbGraphs.append(i + "," + nodeBin.get(i) + "\n");
		}
		FileIO.writeStringToFile(sbGraphs.toString(), "/Users/farazgurramkonda/IdeaProjects/CPatMinerV2/CPatMinerV2/AtomicASTChangeMining/graphs.csv");
	}
