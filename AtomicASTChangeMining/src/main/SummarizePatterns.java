...
public class SummarizePatterns {
	...
	private static HashMap<String, String> commitEmail = new HashMap<>(), commitAuthor = readAuthor(new File("/Users/farazgurramkonda/IdeaProjects/CPatMinerV2/AtomicASTChangeMining/Res"));
...
//						}
		...
		File outDir = new File("/Users/farazgurramkonda/IdeaProjects/CPatMinerV2/CPatMinerV2/CPatMinerV2/AtomicASTChangeMining/chang-patterns-sum-" + dir.getParentFile().getName() + "/dates");
		if (!outDir.exists())
			outDir.mkdirs();
