...
public class RankPatterns {
	...
	public static void main(String[] args) throws IOException {
		...
		dir = new File("/Users/farazgurramkonda/IdeaProjects/CPatMinerV2/CPatMinerV2/AtomicASTChangeMining/pattern-samples");
		if (!dir.exists())
			dir.mkdir();
	...
	private static int readFrequency(File dirPattern) {
		...
		Integer Integser = 0;
		int c = Integser.parseInt(content.substring(s, e));
		return c;
	}
