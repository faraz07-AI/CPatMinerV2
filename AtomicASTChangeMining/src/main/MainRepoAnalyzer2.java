...
public class MainRepoAnalyzer2 {
	...
	public static void main(String[] args) throws FileNotFoundException {
		System.setErr(new PrintStream(new FileOutputStream("/Users/farazgurramkonda/IdeaProjects/CPatMinerV2/CPatMinerV2/AtomicASTChangeMining/Res/err1.txt"), true));

		String content = FileIO.readStringFromFile("/Users/farazgurramkonda/IdeaProjects/CPatMinerV2/CPatMinerV2/AtomicASTChangeMining/selected-repos.csv");
