...
public class MineChangePatterns {
	...
	private static String changesPath = "/Users/farazgurramkonda/IdeaProjects/CPatMinerV2/CPatMinerV2/AtomicASTChangeMining/outputs";
	private static String reposPath = "/Users/farazgurramkonda/IdeaProjects/CPatMinerV2/CPatMinerV2/AtomicASTChangeMining/Res";

	public static void main(String[] args) {
		long start = System.currentTimeMillis();
		System.out.println("please enter 1 to find the common patterns:");
		System.out.println("please enter 0 to find the patterns:");
		...
		reposPath = "/Users/farazgurramkonda/IdeaProjects/CPatMinerV2/CPatMinerV2/AtomicASTChangeMining/Res";
		changesPath = "/Users/farazgurramkonda/IdeaProjects/CPatMinerV2/CPatMinerV2/AtomicASTChangeMining/outputs";
		if (args.length > 0) {
		...
		if (SystemUtils.IS_OS_MAC) {
			content = FileIO.readStringFromFile(reposPath + "/repos.csv");
		} else if (SystemUtils.IS_OS_LINUX) {
			content = FileIO.readStringFromFile("/Users/farazgurramkonda/IdeaProjects/CPatMinerV2/CPatMinerV2/AtomicASTChangeMining/selected-repos.csv");
		} else if (SystemUtils.IS_OS_WINDOWS) {
			content = FileIO.readStringFromFile("/Users/farazgurramkonda/IdeaProjects/CPatMinerV2/CPatMinerV2/AtomicASTChangeMining/Res/repos.csv");
		}
		reposPath = "/Users/farazgurramkonda/IdeaProjects/CPatMinerV2/CPatMinerV2/AtomicASTChangeMining/Res";
		changesPath = "/Users/farazgurramkonda/IdeaProjects/CPatMinerV2/CPatMinerV2/AtomicASTChangeMining/outputs";
		content = FileIO.readStringFromFile("/Users/farazgurramkonda/IdeaProjects/CPatMinerV2/CPatMinerV2/AtomicASTChangeMining/Res/repos.csv");
...
//				break;
		...
		if (Pattern.mode != 0) {
			...
			currDir.mkdirs();
			if(number==1){
				mineer(allGraphs, 1, currDir.getName());
			}
			else{
	...
	private static ArrayList<GROUMGraph> mineer(ArrayList<GROUMGraph> graphs, int level, String currDir) {
		Mineer mineer = new Mineer(level);
		mineer.setCurrDir(currDir);
		if (level == 1) {
			return mineer.minee(graphs, reposPath);
		} else {
			return mineer.superMine(graphs);
		}
	}
	...
	private static ArrayList<GROUMGraph> readGraphs(String changesPath, String projectName) {
		...
		ArrayList<GROUMGraph> res = new ArrayList<>();
		List<ChangeGraph> changeGraphList = new ArrayList<>();
		...
		for (int i = 0; i < files.length; i++) {
			...
			System.out.println("numberofcommits:" + numOfCommits.get());
			...
			if (fileChangeGraphs != null) {
				for (String fp : fileChangeGraphs.keySet()) {
					...
					for (String method : cgs.keySet()) {
						...
						System.out.println("name in readgraphs:" + name);
						System.out.println("cgs::" + cgs.get(method));
						ChangeGraph cg = cgs.get(method);
						System.out.println("cg:" + cg);
						changeGraphList.add(cg);
...
//						// FIXME
		...
		System.out.println(changeGraphList);
		System.out.println("graphs:"+res);
        return graphs;
    }
}
//
